...
<div class="container">
    <div class="row bottom_minus_margin_30px">
        <?php if(count($details)>0){ ?>
          ...
          $comment = $this->BlankModel->customQuery("SELECT COUNT(comment) as total_comment from blog_comments WHERE blog_id='$blog_id'");
          //echo $comment[0]->total_comment;
          ?>
                  ...
                  <div class="card blog_card">
                      ...
                      <div class="card-footer text-muted d-flex justify-content-between bg-transparent">
                        ...
                        <div class="stats">
                          ...
                          <i class="fa fa-comment-o text-info"></i> <?=$comment[0]->total_comment?>
                          <?php }else{ ?>
