...
class Ajax_Function extends MY_Controller 
{
    ...
    public function get_products()
    {
      ...
      $sorting_value=$this->input->post('sorting_value');
        ...
        else if($sorting_value=='2')
        {
          $sql .= "";
        }
        else if($sorting_value=='3')
        {
          $sql .= "";
        }
        else if($sorting_value=='4')
        {
          $sql .= "";
        }  
        ...
        {
          $sql .= " ORDER BY gbp_price ASC";
        }
        else if($sorting_value=='4')
        {
          $sql .= " ORDER BY gbp_price DESC";
        }    	
        //echo $sql;
    ...
    public function getproducts()
    {
        ...
        $sortingData=$this->input->post('sortingData');
        ...
        if(count($category_filter)>0)
        {
            ...
            if($sortingData=='1')
            {  
              $sql .= " p.is_popular='1' AND ";
            }
            else if($sortingData=='0')
            {
              $sql .="";
            }
            else if($sortingData=='2')
            {
              $sql .="";
            }
            else if($sortingData=='3')
            {
              $sql .= "";
            }
            else if($sortingData=='4')
            {
              $sql .= "";
            }
            ...
            {
              $sql .= " ORDER BY p.gbp_price ASC ";
            }
            else if($sortingData=='4')
            {
              $sql .= " ORDER BY p.gbp_price DESC ";
            }
