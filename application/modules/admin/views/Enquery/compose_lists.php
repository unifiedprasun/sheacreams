		...
		<div class="card">
			...
			<div class="card-body p-0">
				<ul class="nav nav-sidebar" data-nav-type="accordion">
					...
					<li class="nav-item">
						<a href="<?=base_url()?>admin/Enquery/compose_lists" class="nav-link active"><i class="icon-drawer-out"></i> Sent mail</a>
					</li>
					<li class="nav-item">
...
<div class="content-wrapper">
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<span class="breadcrumb-item active">Sent Mail</span>
				</div>
	...
	<div class="content">
		<div class="card">
			<div class="card-header bg-transparent header-elements-inline">
				<h6 class="card-title">Sent Mail</h6>				
			</div>
				...
				<div class="navbar-collapse text-center text-lg-left flex-wrap collapse" id="inbox-toolbar-toggle-single">
					<div class="mt-3 mt-lg-0">
						<div class="btn-group">
							...
							<button type="button" onclick="delete_compose_lists();" class="btn btn-light"><i class="icon-bin"></i></button>
						...
						<div class="btn-group ml-3 mr-lg-3">
							...
							<button type="button" class="btn btn-light" onclick="delete_compose_lists();"><i class="icon-bin"></i> <span class="d-none d-lg-inline-block ml-2">Delete</span></button>
							...
							<?php foreach($details as $d){ ?>
								<tr class="<?php if($d->is_read == 0){ ?><?php echo "unread"; ?><?php }else{ ?><?php echo "read"; ?><?php } ?>">
									...
									<td class="table-inbox-star rowlink-skip" style="width: 50px">
										...
										<?php if($d->is_read == 0){ ?>
											<a href="<?=base_url()?>admin/Enquery/read_compose/<?=$d->id?>/1"><i class="fa fa-envelope"></i></a>
										<?php }else{ ?>
											<a href="<?=base_url()?>admin/Enquery/read_compose/<?=$d->id?>/0"><i class="fa fa-envelope-open-o"></i></a>
										<?php } ?>
									...
									<td class="table-inbox-name" style="width: 300px">
										<a href="<?=base_url()?>admin/Enquery/view_compose/<?=$d->id?>">
									...
									<td class="table-inbox-time" style="width: 200px">
										<?=date('m F Y h:i A', strtotime($d->sent_date))?>
									</td>
								</tr>
							<?php } ?>
						<?php } ?>
