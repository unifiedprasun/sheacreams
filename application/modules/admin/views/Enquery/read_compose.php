		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<span class="breadcrumb-item active">Read Compose</span>
				</div>
						...
						<div class="navbar navbar-light bg-light navbar-expand-lg border-bottom-0 py-lg-2 rounded-top">
							...
							<div class="navbar-collapse text-center text-lg-left flex-wrap collapse" id="inbox-toolbar-toggle-read">
								<div class="mt-3 mt-lg-0 mr-lg-3">
									<div class="btn-group">										
										<a href="<?=base_url()?>admin/Enquery/delete_compose_single/<?=$details[0]->id?>">
								...
								<div class="navbar-text ml-lg-auto"><?=date('m F Y h:i A', strtotime($details[0]->sent_date))?></div>
							</div>
						</div>
						...
						<div class="card-body">
							<div class="media flex-column flex-md-row">
								...
								<div class="media-body">
									...
									<div class="letter-icon-title font-weight-semibold">From me to <a href="#">&lt;<?=$details[0]->email?>&gt;</a></div>
								</div>								
							</div>
						</div>
						...
						<div class="card-body border-top">	
							<ul class="list-inline mb-0">
								...
								<li class="list-inline-item">
									<a href="<?=base_url()?>admin/Enquery/delete_compose_single/<?=$details[0]->id?>"><button class="btn btn-danger" onclick="return confirm('Are you want to deleted ?');"><i class="fa fa-trash"></i>&nbsp;&nbsp; Delete</button></a>
								</li>
							</ul>
						</div>
					</div>
