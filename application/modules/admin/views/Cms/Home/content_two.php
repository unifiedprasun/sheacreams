...
<div class="content-wrapper">
		...
		<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
			<div class="d-flex">
				<div class="breadcrumb">
					...
					<span class="breadcrumb-item active">Content Two</span>
				</div>
				<a href="javascript:void(0)" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
			</div>
		</div>
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form class="form-validate-jquery" enctype="multipart/form-data" action="<?=base_url()?>admin/Cms/add_content_two_details" method="post">
					<fieldset class="mb-3">	
							...
							<div class="modal fade" id="content<?=$d->id?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<form action="<?=base_url()?>admin/Cms/update_content_two/<?=$d->id?>" method="post" enctype="multipart/form-data">	
											<div class="modal-body">
												...
												<div class="form-group row">
													<label class="col-form-label col-lg-3">Content </label>
													<div class="col-lg-9">
														<textarea class="form-control ckeditor" name="content"><?=$d->content?></textarea>
													</div>
												</div>	
												<div class="form-group row">
													<label class="col-form-label col-lg-3">Image [ MAX Size 2MB ]</label>
